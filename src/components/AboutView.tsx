...
export const AboutView: React.FC<AboutViewProps> = ({
  ...
  const isPolicyCommittee = activeSubTab === 'Policy Committee' || activeSubTab === 'Policy Committee (PC)';
  const isTAC = activeSubTab === 'Technical Advisory Committee' || activeSubTab === 'Technical Advisory Committee (TAC)';
    ...
    <div className="w-full min-h-screen flex flex-col bg-white">
      ...
      <section className="relative h-[380px] sm:h-[440px] w-full flex flex-col justify-between overflow-hidden bg-slate-950">
        ...
        <div className="absolute inset-0 z-0">
          ...
          {/* Top Overlay */}
          <div className="absolute inset-x-0 top-0 h-36 bg-gradient-to-b from-black/85 via-black/45 to-transparent pointer-events-none" />
